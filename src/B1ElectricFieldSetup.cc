...
B1ElectricFieldSetup::B1ElectricFieldSetup()
   ...
   fStepperType(4)     // ClassicalRK4 -- the default stepper
{
  fEMfield = new G4UniformElectricField(
					G4ThreeVector(0.0,0.0,-250 volt/cm)); // Default is -54
...
B1ElectricFieldSetup::B1ElectricFieldSetup(G4ThreeVector fieldVector)
  : fMinStep(0.010*mm),  // minimal step of 10 microns
    fFieldManager(0),
    fChordFinder(0),
    fEquation(0),
...
B1ElectricFieldSetup::~B1ElectricFieldSetup()
{
  // G4cout << " B1ElectricFieldSetup - dtor called. " << G4endl;
...
void B1ElectricFieldSetup::UpdateIntegrator()
{
  ...
  G4cout<< " B1ElectricFieldSetup: The minimal step is equal to "
  ...
  // G4cout << "B1ElectricFieldSetup::UpdateIntegrator> "
...
void B1ElectricFieldSetup::CreateStepper()
{
...
void B1ElectricFieldSetup::SetFieldZValue(G4double fieldValue)
{
...
void B1ElectricFieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
G4FieldManager*  B1ElectricFieldSetup::GetGlobalFieldManager()
{
//  Utility method
